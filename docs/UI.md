...
- **Exercices** : tableau Titre (lien), Identifiant (chasse fixe), État (« Jamais publié », « Brouillon modifié », « À jour » en vert, « Archivé » atténué), Dernière version (« v2 · 2026-09-24 13:05 »), Séances (« 3 séances (v2 : 1, v1 : 2) »), À l'accueil, Actions : **Ouvrir**, **Dupliquer** (demande l'identifiant), **Renommer** (le titre du brouillon), **Archiver** (rouge au contour, confirmation) ou **Rétablir**, **Supprimer** (rouge plein, seulement sans séance, confirmation), **Copier le lien étudiant** (presse-papiers, sinon une boîte avec le lien). Sous le tableau, **Nouvel exercice** : identifiant d'URL et titre, « Créer un exercice vide ».
