// Tests de site/js/format.js : arrondis d'affichage (SPEC §5).
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { formatNumber, formatParameters } from '../site/js/format.js';

test('formatNumber : nombre de décimales fixe, virgule décimale', () => {
...
test('formatParameters : c’est le N plafonné qui est affiché, et une Vc décimale garde sa virgule', () => {
