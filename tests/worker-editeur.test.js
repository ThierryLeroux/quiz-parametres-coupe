...
test('export puis import : l’export réimporté ne change rien (aller-retour identique) ; les séances et attestations ne sont pas touchées', async () => {
  ...
  assert.deepEqual(validation.corps.resume, { tables_ajoutees: [], banque: { ajoutes: [], modifies: [], retires: [], gardes: 29 }, exercices_ajoutes: [], exercices_remplaces: [M10, VC_RPM], versions_ajoutees: [], exercices_gardes: [], images_manquantes: [], images_presentes: 60, images_modifiees: [], brouillon_tables: true });
...
test('import par fusion (D49) : ajoute les exercices, versions et tables absents, remplace les brouillons et la banque ; refuse une version différente sous un numéro existant, un format inconnu, un contenu invalide', async () => {
  ...
  assert.deepEqual(validation.corps.erreurs, []);
  assert.deepEqual({ ...validation.corps.resume, versions_ajoutees: [...validation.corps.resume.versions_ajoutees].sort() }, { tables_ajoutees: [], banque: { ajoutes: [{ id: 'alesoir_3', nom: 'Alésoir (copie)' }], modifies: [], retires: [], gardes: 29 }, exercices_ajoutes: ['nouveau'], exercices_remplaces: [M10, VC_RPM], versions_ajoutees: [`${M10} v2`, 'nouveau v1'], exercices_gardes: ['local'], images_manquantes: [], images_presentes: 60, images_modifiees: [], brouillon_tables: true });
